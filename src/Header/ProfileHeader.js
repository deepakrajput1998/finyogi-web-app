  ...
  return (<>
            <header className='profile--header w-1211'>
                ...
                <nav className='profile--nav'>
                    ...
                    <div className='nav--items'>Article</div>
                    <div className='nav--items'>Learn</div>
                    <div className='nav--items'>Quiz</div>
                                        ...
                                        <div className='notif--card-item'>
                                            <div className='notif--card-head'>
                                                ...
                                                <div className='notif--card-right'>
                                                    <div className='notif--card-title'>Notification Tag</div>
                            ...
                            <div className='profile--menus'>
                                ...
                                <div className='edit--image p-edit--image'>
                                    ...
                                    <div className='profile--menus-head-right'>
                                        ...
                                        <div className='profile--menus-head-sub'>Rahul Kumar Gupta </div>
